...
import { EnquiryFormService, EnquiryFormGroup } from 'app/enquiry/update/enquiry-form.service';
...
@Component({
  selector: 'yali-enquiry-guest-update',
  templateUrl: './enquiry-guest-update.component.html',
})
export class EnquiryGuestUpdateComponent implements OnInit {
