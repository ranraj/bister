...
describe('ProjectSpecification Management Component', () => {
  let comp: ProjectSpecificationComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'project-specification', component: ProjectSpecificationComponent }]),
      ...
      .overrideTemplate(ProjectSpecificationComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.projectSpecifications?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to projectSpecificationService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProjectSpecificationIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getProjectSpecificationIdentifier).toHaveBeenCalledWith(entity);
