...
describe('ProjectType Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'project-type', component: ProjectTypeComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.projectTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to projectTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProjectTypeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getProjectTypeIdentifier).toHaveBeenCalledWith(entity);
