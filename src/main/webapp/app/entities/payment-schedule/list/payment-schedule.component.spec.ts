...
describe('PaymentSchedule Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'payment-schedule', component: PaymentScheduleComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.paymentSchedules?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to paymentScheduleService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPaymentScheduleIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPaymentScheduleIdentifier).toHaveBeenCalledWith(entity);
