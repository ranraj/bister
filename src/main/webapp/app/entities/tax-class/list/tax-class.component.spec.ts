...
describe('TaxClass Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'tax-class', component: TaxClassComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.taxClasses?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to taxClassService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTaxClassIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTaxClassIdentifier).toHaveBeenCalledWith(entity);
