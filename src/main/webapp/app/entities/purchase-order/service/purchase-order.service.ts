...
type RestOf<T extends IPurchaseOrder | NewPurchaseOrder> = Omit<T, 'placedDate'> & {
...
export class PurchaseOrderService {
  ...
  protected convertDateFromClient<T extends IPurchaseOrder | NewPurchaseOrder | PartialUpdatePurchaseOrder>(purchaseOrder: T): RestOf<T> {
    return {
      ...purchaseOrder,
      placedDate: purchaseOrder.placedDate?.toJSON() ?? null,
    };
  }
  ...
  protected convertDateFromServer(restPurchaseOrder: RestPurchaseOrder): IPurchaseOrder {
    return {
      ...restPurchaseOrder,
      placedDate: restPurchaseOrder.placedDate ? dayjs(restPurchaseOrder.placedDate) : undefined,
    };
  }
