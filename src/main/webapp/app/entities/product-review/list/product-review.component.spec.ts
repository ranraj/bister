...
describe('ProductReview Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to productReviewService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProductReviewIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getProductReviewIdentifier).toHaveBeenCalledWith(entity);
