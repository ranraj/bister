...
describe('ProductAttribute Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'product-attribute', component: ProductAttributeComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.productAttributes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to productAttributeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProductAttributeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getProductAttributeIdentifier).toHaveBeenCalledWith(entity);
