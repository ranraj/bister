...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../project-activity.test-samples';
...
describe('ProjectActivity Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a ProjectActivity', () => {
      ...
      service.create(projectActivity).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a ProjectActivity', () => {
      ...
      service.update(projectActivity).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addProjectActivityToCollectionIfMissing', () => {
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(projectActivity);
        expect(expectedResult).toContain(projectActivity2);
      });
