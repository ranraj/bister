...
describe('ProjectActivity Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'project-activity', component: ProjectActivityComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.projectActivities?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to projectActivityService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProjectActivityIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getProjectActivityIdentifier).toHaveBeenCalledWith(entity);
