...
describe('ProductVariation Management Component', () => {
  let comp: ProductVariationComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'product-variation', component: ProductVariationComponent }]),
      ...
      .overrideTemplate(ProductVariationComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.productVariations?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to productVariationService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProductVariationIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getProductVariationIdentifier).toHaveBeenCalledWith(entity);
