...
describe('Phonenumber Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'phonenumber', component: PhonenumberComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.phonenumbers?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to phonenumberService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPhonenumberIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPhonenumberIdentifier).toHaveBeenCalledWith(entity);
