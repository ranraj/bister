...
import com.yalisoft.bister.security.jwt.JWTFilter;
import com.yalisoft.bister.security.jwt.TokenProvider;
import com.yalisoft.bister.web.filter.SpaWebFilter;
...
public class SecurityConfiguration {
    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        ...
        .and()
            ...
            .pathMatchers("/api/_search/projects").permitAll()
            .pathMatchers("/api/products/**").permitAll()
            .pathMatchers("/api/categories/**").permitAll()            
            .pathMatchers("/api/enquiries/**").permitAll()
