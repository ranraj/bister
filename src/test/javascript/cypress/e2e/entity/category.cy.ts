...
describe('Category e2e test', () => {
  ...
  const categorySample = { name: 'redundant Steel teal', slug: 'back protocol red' };
  ...
  describe('new Category page', () => {
    ...
    it('should create an instance of Category', () => {
      ...
      cy.get(`[data-cy="slug"]`).type('service-desk end-to-end').should('have.value', 'service-desk end-to-end');

      cy.get(`[data-cy="description"]`).type('Sports quantify framework').should('have.value', 'Sports quantify framework');

      cy.get(`[data-cy="categoryType"]`).select('Product');
