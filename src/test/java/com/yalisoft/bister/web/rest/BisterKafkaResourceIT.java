...
class BisterKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/bister-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
