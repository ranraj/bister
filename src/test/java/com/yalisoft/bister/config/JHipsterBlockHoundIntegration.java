...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.yalisoft.bister.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.yalisoft.bister.security.DomainUserDetailsService", "createSpringSecurityUser");
